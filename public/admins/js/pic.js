$(function () {
    ...
    $('#file_upload').uploadify({
        ...
        'onUploadSuccess' : function(file, date, response) {
            ...
            if(data.valid==1){
                var str='<div class="images"><input name="pic" type="hidden" value="'+data.msg+'"/><img src="'+'/uploads/'+data.msg+'" width="410" height="410"><a href="javascript:;" class="btn btn-danger col-sm-offset-1 delimg">删除</a></div>';
